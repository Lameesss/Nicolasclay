...
export const PLANS: PLAN[] = [
    {
        id: "standard",
        title: "Standard",
        desc: "Designed for solopreneurs and small teams ready to elevate their brand and client acquisition with proven frameworks.",
        monthlyPrice: 29,
        annuallyPrice: 306,
        buttonText: "Upgrade to Standard",
        features: [
            "Growth playbooks (monthly)",
            "Core brand positioning guide",
            "Ideal client targeting worksheets",
    ...
    },
    {
        id: "mastermind",
        title: "Mastermind",
        desc: "Perfect for ambitious consultants and agencies seeking premium strategies and hands-on guidance to scale faster.",
        monthlyPrice: 79,
        annuallyPrice: 834,
        badge: "Most Popular",
        ...
        features: [
            ...
            "Personalized brand strategy sessions",
            "Premium client acquisition funnels",
            "Custom sales scripts & templates",
