                ...
                <Container>
                    <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                            Choose the plan built for  <br className="hidden lg:block" />{" "}
                            <span className="font-subheading italic">your growth</span>
                        </h2>
                        <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                            Elevate your consulting brand with psychology-driven strategies, actionable frameworks, and expert support everything you need to attract premium clients and scale with confidence.
                        </p>
                    </div>
                </Container>
