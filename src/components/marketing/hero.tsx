...
const Hero = () => {
  return (
    <div id="hero" className="relative flex flex-col items-center justify-center w-full pt-8 pb-20 md:py-20">
        ...
        <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
          ...
          <Container delay={0.15}>
            <h1 className="text-4xl md:text-4xl lg:text-7xl font-bold text-center !leading-tight max-w-4xl mx-auto">
              Unlock <br /> <span className="">High-Ticket Growth </span>
              for Your Expertise
          ...
          <Container delay={0.2}>
            <p className="max-w-xl mx-auto mt-2 text-base lg:text-lg text-center text-muted-foreground">
              Productize your skills, master premium positioning, and attract clients with proven psychology-driven frameworks.
            </p>
          </Container>
          ...
          <Container delay={0.3} className="relative">
            <div className="relative rounded-xl lg:rounded-[32px] border border-border p-2 backdrop-blur-lg mt-10 max-w-6xl mx-auto">
              ...
              <YouTubeThumbnail videoId="SM16h0FRByc" title="Vetra Demo" />
            </div>
